...
\begin{abstract}
	...
	Oleksandr Voloshyn: Worked on 4.1, 4.2, 4.3, 5.1
...
\begin{enumerate}
	...
	Weak: No, linear weak scaling would ideally be when the runtime does not vary with scaling. We could instead see\todo{Here add reference to the scaling efficiency plot!} a marked increase in runtime in this case.

	Strong: Yes for the strong scaling case we could observe almost perfect linear scaling. (TODO: more details here\todo{Here add reference to the scaling efficiency plot!} )
	}
