...
\begin{enumerate}
	...
	Theoretically, this would result in calculation/communication overlap, as new rows 
	would be received as calculation using previous rows was taking place. We can compare the Vampir
	plots for 
